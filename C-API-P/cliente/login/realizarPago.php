<?php
    ...
    if($respuesta->paid == true){
        ...
        $colonia = Casa::DatosColoniaid($casa['fk_colonia']);
        $id_colonia = $colonia['id_colonia'];
        $dias_renta_casa = $casa['dias_rentas'] + $diferencia;
        $cantidad_rentas_casa = $casa['cantidad_rentas'] + 1;
        $dias_renta_colonia = $colonia['dias_rentas'] + $diferencia;
        $cantidad_rentas_colonia = $colonia['cantidad_rentas'] + 1;
