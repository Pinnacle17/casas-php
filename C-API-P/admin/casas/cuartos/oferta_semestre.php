<?php
    ...
    if($oferta == null){
        ...
        if($compra == null){
            ...
            $datos_compra_completos['fk_usuario'] = $compra[0]['fk_usuario'];
            $datos_compra_completos['foto'] = $usuario[0]['foto'];
            $datos_compra_completos['nombre_usuario'] = $usuario[0]['nombre_usuario'];
            $datos_compra_completos['celular'] = $usuario[0]['celular'];
            $datos_compra_completos['celular_ext'] = $usuario[0]['celular_ext'];
            $datos_compra_completos['fecha_compra'] = $compra[0]['fecha_compra'];
